...
from config import ChatConfig, Config, RainEffectConfig, SecretConfig, LetterConfig
...
def index() -> str:
    ...
    frontend_config = {
        ...
        "LETTER_RED_TEXT_SIZE": LetterConfig.RED_TEXT_SIZE,
        "LETTER_BLACK_TEXT_SIZE": LetterConfig.BLACK_TEXT_SIZE,
